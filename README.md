...
### 4. 物品管理器
- **自动钓鱼**: 修复TerraAngel自带的自动钓鱼功能
- **自动垃圾桶**：智能回收+排除表+物品返还功能
- **连锁挖矿**：自定义破坏图格ID+连锁范围
- **一键修改**： `P键`修改所有饰品前缀（排除盔甲槽）
- **反重力药水**：支持反重力球/反重力下挖矿放置/抓钩/智能光标
- **自动使用物品** `J键`自动使用手持物品
- **鼠标范围伤害NPC** 不设伤害则以手上物品伤害作参考，实时绘制直径范围
...
### v1.1.9
- 加入了自动寻宝(图格测距UI绘制)
- 重构玩家头顶UI支持遮挡自动隐藏与鼠标悬停显示
- 玩家头顶UI支持获取物品
- 支持显示自己头顶UI 与 NPC头顶UI
- NPC血量被服务器修改后,支持修正头顶UI血条长度

### v1.1.8
- 加入了自动钓鱼(修复版)
- 加入了修改伤害倍率
- 加入了实时绘制其他玩家头顶UI（显示距离格数,血量,攻击,防御,手持物品)
- 加入了绘制鼠标伤害范围圆形
- 移除了物品编辑器与一键收藏背包物品功能
- 重构了一键前缀(支持专家难度)
- 给回到死亡地点加入了快捷键B
- 将一些功能位置UI调整到合理的分类内
- 适配TerraAngel 2.4.1 && Terraria 1.4.5.6

### v1.1.7
- 适配1.4.5
- 移除了配方管理器、NPC瞬移回家、社交栏饰品生效(懒得修)
